...
ruby server.rb $5 > log/$4$1_$2_$3_$TIME.serverlog &
SRVID=$!
sleep 1
ruby recv_client.rb $1 $2 $3 $5 > log/$4$1_$2_$3_$TIME.recvlog &
RECVID=$!
sleep 1
ruby send_client.rb $1 $2 $3 $5 > log/$4$1_$2_$3_$TIME.sendlog &
